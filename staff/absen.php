                            ...
                            <div class="card-body">
                                <form action="p_absen.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="jammasuk" readonly type="text" class="form-control" value="<?php date_default_timezone_set('Asia/Jakarta');
                                    ...
                                    <p style="color: red"><i>Catatan : Upload foto saat anda tiba di tempat kerja jika keterangan hadir dan Upload surat izin jika keterangan izin.</i></p>
                                    <br>
                                    <center>
