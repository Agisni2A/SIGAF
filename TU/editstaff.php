            ...
            <div class="main-content">
                <div class="col-lg-12">
                    <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                        ...
                        <div class="col-lg-12">
                            <div class="card-body">
                                <form action="p_editstaff.php" method="POST">
                                    <?php
                                    include "../koneksi.php";
                                    $id = $_GET['id'];
                                    $q = mysqli_query($con, "SELECT * FROM staff WHERE id='$id'");
                                    ...
                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="jk" class="form-control">
                                                <option value="<?= $d['nip'] ?>"><?= $d['jk'] ?></option>
                                                <option value="Laki-laki">Laki-laki</option>
                                                <option value="Perempuan">Perempuan</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label mb-1">Tempat & Tanggal Lahir</label>
                                            <input name="ttl" type="text" class="form-control" value="<?= $d['ttl'] ?>">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label mb-1">Pendidikan</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input name="hp" type="text" class="form-control" value="<?= $d['hp'] ?>">
                                        </div>
                                        <br>
                                        <center>
