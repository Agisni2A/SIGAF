                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center">Jadwal Kelas</th>
                                                <th style="text-align: center">Bidang Studi</th>
                                                <th style="text-align: center">Tanggal dan Jam Absen</th>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    ...
                                                    <a href="p_hapusabsenguru.php?id=<?= $d['id'] ?>" class="btn btn-primary" style="background-color: red">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </table>
                        </center>
                        <p style="color: red">&nbsp;&nbsp;&nbsp;&nbsp;<i>*Catatan : Hapus data absensi guru yang sudah tidak diperlukan.</i></p>
                        <br>
                        <center>
                            <a href="cetak_absensiguru.php" class="btn btn-primary"><i class="fas fa-print"></i>&nbsp;&nbsp;Cetak Absensi</a>
                        </center>
                        <br>
                    </div>
                </div>
