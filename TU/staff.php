                ...
                <div class="col-lg-12">
                    <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                        <center>
                            ...
                            <h2>Data Staff</h2>
                            <hr>
                            <a href="tambahstaff.php" class="btn btn-primary">+ Staff</a>
                            <br><br>
                            <div class="col-lg-12">
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center">Tempat<br>&<br>Tanggal Lahir</th>
                                        ...
                                        <?php
                                        include "../koneksi.php";
                                        $q = mysqli_query($con, "SELECT * FROM staff");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="editstaff.php?id=<?= $d['id'] ?>" class="btn btn-primary">Edit</a>
                                                    <a href="p_hapusstaff.php?id=<?= $d['id'] ?>" class="btn btn-primary" style="background-color: red">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </table>
