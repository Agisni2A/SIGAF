            ...
            <table border="1">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center" width="100px">Jabatan</th>
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align: center"><?php echo "<img src='img/bukti staff/" . $d['foto'] . "'width='100px' height='100px'/>" ?><br><?php echo $d['foto'] ?></td>
