                ...
                <div class="col-lg-12">
                    <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                        <center>
                            ...
                            <h2>Data Guru</h2>
                            <hr>
                            <a href="tambahguru.php" class="btn btn-primary">+ Guru</a>
                            <br><br>
                            <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning">
                                        ...
                                        <?php
                                        include "../koneksi.php";
                                        $q = mysqli_query($con, "SELECT * FROM guru");
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center">
                                                    <a href="editguru.php?id=<?= $d['id'] ?>" class="btn btn-primary">Edit</a>
                                                    <a href="p_hapusguru.php?id=<?= $d['id'] ?>" class="btn btn-primary" style="background-color: red">Hapus</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </table>
